...
class LocationTests: XCTestCase {
    ...
    func test_location_isEquatable_coordinatesLatitudeDifferent() {
        let firstCoordinate = Coordinate(latitude: 1, longitude: 2)
    ...
    func test_location_isEquatable_coordinatesLongitudeDifferent() {
        let firstCoordinate = Coordinate(latitude: 1, longitude: 2)
        let secondCoordinate = Coordinate(latitude: 1, longitude: 1)
        let firstLocation = Location(name: "First", coordinate: firstCoordinate)
        let secondLocation = Location(name: "First", coordinate: secondCoordinate)
    ...
    func test_location_isEquatable_coordinatesLatitudeSmallDifference() {
        let firstCoordinate = Coordinate(latitude: 1.000_000_01, longitude: 2)
        let secondCoordinate = Coordinate(latitude: 1, longitude: 2)
        let firstLocation = Location(name: "First", coordinate: firstCoordinate)
        let secondLocation = Location(name: "First", coordinate: secondCoordinate)
    ...
    func test_location_isEquatable_coordinatesLatitudeLargeDifference() {
        let firstCoordinate = Coordinate(latitude: 1.000_000_2, longitude: 2)
        let secondCoordinate = Coordinate(latitude: 1, longitude: 2)
        let firstLocation = Location(name: "First", coordinate: firstCoordinate)
        let secondLocation = Location(name: "First", coordinate: secondCoordinate)
    ...
    func test_location_isEquatable_coordinatesLongitudeSmallDifference() {
        let firstCoordinate = Coordinate(latitude: 1, longitude: 2.000_000_01)
        let secondCoordinate = Coordinate(latitude: 1, longitude: 2)
        let firstLocation = Location(name: "First", coordinate: firstCoordinate)
        let secondLocation = Location(name: "First", coordinate: secondCoordinate)
        XCTAssertEqual(firstLocation, secondLocation, "Two locations shall be equal within a tolerance of 0.000_000_1 for longitude.")
    }

    func test_location_isEquatable_coordinatesLongitudeLargeDifference() {
        let firstCoordinate = Coordinate(latitude: 1, longitude: 2.000_000_2)
        let secondCoordinate = Coordinate(latitude: 1, longitude: 2)
        let firstLocation = Location(name: "First", coordinate: firstCoordinate)
        let secondLocation = Location(name: "First", coordinate: secondCoordinate)
